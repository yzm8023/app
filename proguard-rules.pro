...
-keepclasseswithmembers class * extends android.app.Activity{
    public void onEventMainThread(com.godinsec.glauncher.model.RefreshEvent);
    public void onEventMainThread(com.godinsec.glauncher.model.UnInstallAppEvent);
}
...
-keepclasseswithmembers class com.smonline.virtual.client.NativeEngine{ *; }
#--------------------------------------------------------------------------------------------------
#-------------------------------------------3.保留的实体类-------------------------------------------
# 保持bean目录下文件不被混淆
...
#-------------------------------------------4.不混淆广告-------------------------------------------
# 保持有米广告不被混淆
-dontwarn wer.xds.fds.**
-keep class wer.xds.fds.** { *; }
#--------------------------------------------------------------------------------------------------
